...
import { ChevronLeft, ChevronRight, Search, Globe, X, Map, ArrowRight, ShoppingBag, AlignRight, Calendar, Phone } from "lucide-react"
...
export default function HealthcarePage() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col" style={{ backgroundColor: '#F1D5C9' }}>
      ...
      <div className="absolute top-0 right-0 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-[calc(50%-1.5rem)] z-10">
        <div className="relative rounded-bl-2xl overflow-hidden">
          <Image
            ...
            width={600}
            height={384}
            className="w-full h-94 sm:h-106 md:h-110 lg:h-126 object-cover"
          />
          ...
          <div className="absolute top-2 left-2 sm:top-4 sm:left-4 flex items-center">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white/60 backdrop-blur-md rounded-full flex items-center justify-center shadow-lg">
              <Map className="w-3 h-3 sm:w-4 sm:h-4 text-white font-bold" />
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative min-h-[600px]">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0">
              ...
              <div className="w-[760px] h-[760px] rounded-full border-2 border-[#7e716b] bg-transparent flex items-center justify-center">
                {/* Middle circle - medium */}
                <div className="w-[660px] h-[660px] rounded-full border-2 border-[#7e716b] bg-transparent flex items-center justify-center">
                  {/* Inner circle - smallest with text */}
                  <div className="w-[560px] h-[560px] rounded-full border-2 border-[#7e716b] flex items-center justify-center">
                    <h2 className="text-5xl text-gray-800 text-center whitespace-pre-line leading-tight">
                      {t.whyUs}
                    </h2>
                  </div>
                </div>
      ...
      <section className="px-6 py-16">
        <div className="mx-6">
          ...
          <div className="flex justify-center mb-12">
            <div className="bg-white rounded-xl p-1 inline-flex w-[95%] max-w-9xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((index) => {
              ...
              return (
                <Card key={index} className="bg-white border-0 outline-0 transition-shadow overflow-hidden">
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-sm text-gray-500 py-3">
                          {index === 1 ? "Спеціалізується на діагностиці та лікуванні захворювань..." :
                           index === 2 ? "Допомагає пацієнтам досягти здорового способу життя..." : 
                           "Експерт з питань харчування та метаболізму з 10-річним досвідом роботи..."}
                        </p>
                      </div>
                      {/* Top margin line - touching edges */}
                      <div className="w-[calc(100%+3rem)] h-px bg-black -ml-6"></div>
                      <div className="flex items-center min-h-[60px] mt-0">
                        <Button size="sm" variant="ghost" className="font-semibold flex-1 text-sm bg-white text-black border-0 flex items-center justify-center gap-2 rounded-none py-4">
                          <Calendar className="w-4 h-4 text-[#E8888A]" />
                          {t.appointmentBtn}
                        </Button>
                        {/* Vertical separator - same thickness as top line */}
                        <div className="w-[1.5px] bg-black self-stretch"></div>
                        <Button size="sm" variant="ghost" className="font-semibold flex-1 text-sm bg-white text-black border-0 flex items-center justify-center gap-2 rounded-none py-4">
      ...
      <section className="px-6 py-16">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl text-black p-4">{t.ecoPackage}</h2>
      ...
      <footer className="bg-[#0F0504]py-12 w-full">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <nav className="flex flex-wrap gap-8 text-md">
